...
part of 'api_local_service.dart';
...
class _ApiLocalService implements ApiLocalService {
  _ApiLocalService(this._dio, {this.baseUrl, this.errorLogger}) {
  ...
  Future<SearchRecipeWithAiResponseModel> searchRecipeWithAi(
    SearchRecipeWithAiRequestModel body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(body.toJson());
    final _options = _setStreamType<SearchRecipeWithAiResponseModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/ai/serach-ai',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SearchRecipeWithAiResponseModel _value;
    try {
      _value = SearchRecipeWithAiResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
