...
class AppColors {
  ...
  static const Color primaryDarker = Color(0xff71B1A1);
  ...
  static const Color secondaryDarker = Color(0xffFFA61A);
  static const Color secondaryMedium = Color(0xffFFBA4D);
  static const Color secondaryLight = Color(0xffFFCE80);
  static const Color secondaryLighter = Color(0xffFFE1B3);
